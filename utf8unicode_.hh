...
class Utf8Unicode {
public:
    static bool utf8_to_unicode(std::vector<uint32_t>& utf8, std::vector<uint32_t>& unicode) {
    ...
    static void unicode_to_utf8(const std::vector<unsigned int>& unicode, std::vector<unsigned int>& utf8) {
